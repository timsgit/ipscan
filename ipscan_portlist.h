...
const struct portlist_struc defportlist[] =
{
		...
		{  137, 0, "NetBIOS name server" },\
		{  138, 0, "NetBIOS Datagram server" },\
		...
		{27018, 0, "MongoDB shard server"},\
		{27019, 0, "MongoDB config server"},\
		{27020, 0, "MongoDB crypt server"},\
